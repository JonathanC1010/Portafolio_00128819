/* 
 * File:   Lista de libros
 * Author:
 * Jonathan Alexis Cardona Garcia 00128819
 *
 * Created on 10 de octubre de 2019, 07:40 PM
 */
...
bool disEspa() {
    ...
    //Si s!=NULL entonces el libro SI hay libros en español
    //Si s==NULL entonces el libro NO hay libros en español
    return (s != NULL);
}
...
bool CiFi() {
    ...
    //Si s!=NULL entonces el libro SI hay libros de ciencia ficcion
    //Si s==NULL entonces el libro NO hay libros de ciencia ficcion
    return (s != NULL);
}
...
int main(){
    ...
    do{
        ...
        cout << "Menu: \n\t0) Salir\n\t1) Agregar Libro\n\t2) Ver Libros"
            << "\n\t3) Eliminar libro\n\t4) Buscar Libro"
            << "\n\t5) Disponibilidad en español\n\t6) Existencia de libros CiFi\n\t7) Eliminar libros de misterio\n\tOpcion elegida: ";
        cin >> opcion;
        switch(opcion){
            ...
            break;
            case 5: if(disEspa())
                    cout << "SI hay libros en español" << endl;
                else
                    cout << "NO hay libros en español"<< endl;
            break;
            case 6: if(CiFi())
                    cout << "SI hay libros de ciencia ficción" << endl;
                else
                    cout << "NO hay libros de ciencia ficción"<< endl;
            break;
